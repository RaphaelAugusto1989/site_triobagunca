...
<tr onmouseover="ChangeColor(this, true);" onmouseout="ChangeColor(this, false);" onclick="DoNav('altera_linhas.php?id=<?php echo $lj['id_parceiro'];?>');">
    <td class="linha" align="center" valign="middle">
      <?php echo "<img src='../img/parceiros_vips/".$lj['img_parceiro']."' class='imgserv' width=\"200\" height=\"200\">";?>
...
function aviso(id) {
  if (confirm ("Deseja realmente excluir?")) {
      window.location.href = "../processos/bd_delet_parceiros_vips.php?id="+id;
  }
  else {
