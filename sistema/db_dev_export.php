...
$diretorio_para_grava_backup = 'backupBdDev';
...
if($back == true)
	echo "<span style='color: #03B401;'>Backup do Banco de Dados DEV Realizado com sucesso as ".date("H:i:s")."!</span>";
else
