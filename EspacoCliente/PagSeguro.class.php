<?php
class PagSeguro{
	private $email         = "financeirotriobagunca@gmail.com";
	private $token_sandbox = "796A878EEA33468C92792336FD1F7912";
	private $token_oficial = "8d66662b-f05c-4e79-b419-85a308bb9aeef47ebfb44a2cb9fe001be214a357187f710b-242a-4478-87d6-bc4d4784fdf0";
	private $url_retorno   = "https://triobagunca.com.br/EspacoCliente/pagseguro/notificacao.php";
	...
	*/	
	private function generateUrl($dados,$retorno){
		...
		$data['shippingAddressDistrict'] = utf8_encode($dados['bairro']);
