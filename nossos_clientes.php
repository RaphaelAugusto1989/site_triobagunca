...
<div id="corpo"><!--INICIO CORPO-->
	...
	<div id="corpo_galeria">
		...
		$sql = DBRead ("clientesvips");
		$countTotal  = count($sql); // Quantidade de registros pra paginação

		//LÊ DADOS DO BANCO
		$lojas = DBRead ("clientesvips", "ORDER BY id_clientevip DESC LIMIT $inicial, $numreg", "*");

		foreach ($lojas as $lj) {

		echo "<a href='img/clientesvips/".$lj['imagem_clientesvips']."' data-lightbox='roadtrip'>
				<div class='hoverzoom'>
					<img src='img/clientesvips/".$lj['imagem_clientesvips']."'>
				</div>
			 </a>";
		  }
		?>
